...
void CPU::ins_LD_XX_u16(Byte* const registerOne, Byte* const registerTwo)
{
	switch (this->mCyclesUsed)
	{
	case 0: { *registerTwo = this->get_byte_from_pc(); } this->mCyclesUsed++; break;
	case 1: { *registerOne = this->get_byte_from_pc(); } this->mCyclesUsed++; break;
	case 2: { } this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_LD_SP_u16(Word* const registerWord)
{
	...
	switch (this->mCyclesUsed)
	{
	case 0: { *registerWord = (*registerWord & 0xFF00) | this->get_byte_from_pc(); } this->mCyclesUsed++; break;
	case 1: { *registerWord = (*registerWord & 0x00FF) | (this->get_byte_from_pc() << 0x8); } this->mCyclesUsed++; break;
	case 2: { } this->isExecutingInstruction = false; break;
	}
...
void CPU::ins_LD_bXXb_Y(const Word registerWordvalue, Byte* const registerByte)
{
	switch (this->mCyclesUsed)
	{
	case 0: { this->bus->set_memory(registerWordvalue, *registerByte, MEMORY_ACCESS_TYPE::cpu); } this->mCyclesUsed++; break;
	case 1: { } this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_LD_bHLb_Apm(bool add)
{
	switch (this->mCyclesUsed)
	{
	case 0: { this->bus->set_memory(this->registers.get_HL(), this->registers.a, MEMORY_ACCESS_TYPE::cpu); add ? this->registers.set_HL(this->registers.get_HL() + 1) : this->registers.set_HL(this->registers.get_HL() - 1); } this->mCyclesUsed++; break;
	case 1: { } this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_INC_XX(Byte* registerOne, Byte* registerTwo)
{
	switch (this->mCyclesUsed)
	{
	case 0: this->registers.set_word(registerOne, registerTwo, (this->registers.get_word(registerOne, registerTwo) + 1)); this->mCyclesUsed++; break;
	case 1: { } this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_INC_bHLb()
{
	...
	}; this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_LD_X_u8(Byte* const registerByte)
{
	...
	{
	case 0: {}; this->mCyclesUsed++; break;
	case 1: { *registerByte = this->get_byte_from_pc(); }; this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_LD_bHLb_u8()
{
	...
	case 0: {}; this->mCyclesUsed++; break;
	case 1: {}; this->mCyclesUsed++; break;
	case 2: { this->bus->set_memory(this->registers.get_HL(), this->get_byte_from_pc(), MEMORY_ACCESS_TYPE::cpu); }; this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_JR_i8()
{
	...
	case 0: {}; this->mCyclesUsed++; break;
	case 1: { this->instructionCache[0] = this->get_byte_from_pc(); }; this->mCyclesUsed++; break;
	case 2: { this->registers.pc += (Byte_s)this->instructionCache[0]; }; this->isExecutingInstruction = false; break;
	}
}

void CPU::ins_JR_Z_i8()
{
	switch (this->mCyclesUsed)
	{
	case 0: {}; this->mCyclesUsed++; break;
...
void CPU::ins_ADD_HL_XX(Byte* const registerOne, Byte* const registerTwo)
{
	...
	case 1: { this->registers.h = *registerOne; }; this->isExecutingInstruction = false; break;
	}
}
...
void CPU::ins_ADD_HL_SP()
{
	...
	case 1: { this->registers.h = (this->registers.sp & 0xFF00) >> 8;  }; this->isExecutingInstruction = false; break;
	}
}
